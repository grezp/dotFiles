...
# conda
alias con-search 'conda search -c conda-forge $1'
alias con-install 'conda install -c conda-forge $1'
...
setenv PATH ${PATH}:$HOME/local/nvim-linux64/bin
setenv PATH ${PATH}:$HOME/miniconda3/bin
