...
#color changes to bash promt
#export PS1='\! \u:\w$ '
#etenv PS1 "\[\033[1;34m\]\u@\h\[\033[0m\]:\[\033[1;34m\]\w\[\033[0m\]$ "
#PS1='\[\e[31;1m\][\u@\[\e[34;1m\]\H \W]# \[\e[0m\]

#colors!!!!
#set  green="%{\033[0;32m%}"
#set   blue="%{\033[0;34m%}"
set  green="%{\e[38;5;47m%}"
set  blue="%{\e[38;5;36m%}"
set    end="%{\033[0m%}"
...
# vncserver
#alias vnc-start 'vncserver -geometry 1920x1080 -geometry 2560x1440 -geometry 3840x1200 -geometry 1920x1200 $1'
#alias vnc-start 'vncserver -geometry 1920x1080 -xrandr 2560x1440,3840x1200,1920x1200 $1'
...
alias res-ex 'xrandr -s 1920x1200'
alias res-dual 'xrandr -s 3840x1200'
alias res-2k 'xrandr -s 2560x1440'
...
# ssh alias
alias ssh-sim 'ssh pgutierr@unison-san101-01'
alias ssh-thor 'ssh pgutierr@thor'
alias ssh-hawk 'ssh pgutierr@hawkeye'
alias ssh-stark 'ssh pgutierr@stark'
