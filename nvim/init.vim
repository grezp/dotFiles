...
set mouse=a                     " allow mouse controls
set wildignorecase
...
" set signcolumn=number           " Always show the signcolumn, otherwise it shift diag appears
" }}}
...
silent! call plug#begin()
    ...
    Plug 'jiangmiao/auto-pairs'                     " auto gen matching brackets
call plug#end()
